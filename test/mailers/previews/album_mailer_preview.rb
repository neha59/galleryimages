...
class AlbumMailerPreview < ActionMailer::Preview
  ...
  # Preview this email at http://localhost:3000/rails/mailers/album_mailer/create_album
  def create_album
    album = Album.last
  ...
  # Preview this email at http://localhost:3000/rails/mailers/album_mailer/edit_album
  def edit_album
    album = Album.last
